        ...
        {build.map((element) => (
          <tbody>
            <tr>
              ...
              <td>{new Date(element.build_data.buildStartedAt).toLocaleDateString()}</td>
              <td>{element.build_data.buildStatus.toUpperCase()}</td>
              <td>
                <span class="badge badge-success">{element.build_data.totalPassAssertion}</span>
              </td>
              <td>
                <span class="badge badge-danger">{element.build_data.totalFailAssertion}</span>
              </td>
              <td>
                <a
                  href="/buildreport"
